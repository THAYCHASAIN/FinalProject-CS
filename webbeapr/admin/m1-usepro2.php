                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-sm-8">
                                                        ...
                                                        <form class="form-horizontal">
                                                            ...
                                                            <div class="form-group">
                                                                <h4>โปรโมชั่น : 001</h4>
                                                                <h4>ประเภทโปรโมชั่น : โปรโมชั่นของแถม</h4>
                                                                <h4>ผู้ดูแล : Thaychasain.CH</h4>
                                                                <h4>วันหมดเขต : 30/06/2017</h4>
                                                                <h4>วันที่ใช้งาน : 29/05/2017</h4>
                                                                <h4>ชื่อลูกค้า : หมีตัวกลม</h4>
                                                            </div>
                                                            <div class="form-group">
                                                                <label class="control-label col-sm-3" for="email"></label>
                                                                <div class="col-sm-8">
                                                                    <a href="m1-usepro2.php" type="button" class="btn-lg btn-success"></i>ยืนยันรายการ </a>
                                                                    <a href="m1-usepro2.php" type="button" class="btn-lg btn-danger"> </i>ยกเลิกรายการ</a>
                                                                </div>
                                                            </div>
                                                        </form>
                                                    </div>
