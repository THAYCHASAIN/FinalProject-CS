                            ...
                            <div class="col-lg-2 col-xs-6">
                                <div class="panel panel-default">
                                    <ul class="nav nav-pills nav-stacked">
                                        ...
                                        <li class="active"><a href="m1-pro.php">โปรโมชั่น</a></li>
                            ...
                            <div class="panel panel-default">
                                ...
                                <div class="panel panel-default">
                                    ...
                                    <div class="panel-body">          
                                        ...
                                        <div class="container">
                                            <form>
                                            <a href="m1-usepro.php" type="button" class="btn btn-primary btn-lg"> <i class="fa fa-plus-square"></i> เพิ่มโปรโมชั่นใหม่</a>
                                            
                                      
                                                <label class="checkbox-inline">
                                                    <input type="checkbox" value="">  โปรโมชั่นลดราคา
                                                </label>
                                                <label class="checkbox-inline">
                                                    <input type="checkbox" value="">  โปรโมชั่นของแถม
                                                </label>
                                                <label class="checkbox-inline">
                                                    <input type="checkbox" value="">  โปรโมชั่นคูปอง
                                                </label>
                                                <label class="checkbox-inline">
                                                    <input type="checkbox" value="">  โปรโมชั่นแลกซื้อ
                                                </label>
                                                <label class="checkbox-inline">
                                                    <input type="checkbox" value="">  โปรโมชั่นชิงโชค
                                                </label>
                                            ...
                                            <div class="row">
                                                ...
                                                <!-- Info box -->
                                                    <div class="box box-solid box-info">
                                                        <div class="box-header">
                                                            <h3 class="box-title">โปรโมชั่น : 001</h3>
                                                        ...
                                                        <div class="box-body">
                                                        <img class="img-responsive" src="image/pro1/1.jpg" alt="Chania">
                                                        <h4>โปรโมชั่น : 001</h4>
                                                        <h4>ผู้ดูแล : Thaychasain.CH</h4>
                                                        <h4>วันที่สร้าง : 30/04/2017</h4>
                                                        <h4>วันหมดเขต : 30/06/2017</h4>
                                                        <button type="button" class="btn btn-primary btn-block">รายละเอียด</button>
                                                        </div><!-- /.box-body -->
                                                    </div><!-- /.box -->
                                                </div><!-- /.box -->
                                                <div class="col-md-4">
                                                <!-- Info box -->
                                                    <div class="box box-solid box-info">
                                                        <div class="box-header">
                                                            <h3 class="box-title">โปรโมชั่น : 002</h3>
                                                            <div class="box-tools pull-right">
                                                                <button class="btn btn-info btn-sm" data-widget="collapse"><i class="fa fa-minus"></i></button>
                                                                <button class="btn btn-info btn-sm" ><i class="fa fa-cog"></i></button>
                                                            </div>
                                                        ...
                                                        <div class="box-body">
                                                        <img class="img-responsive" src="image/pro1/2.jpg" alt="Chania">
                                                        <h4>โปรโมชั่น : 001</h4>
                                                        <h4>ผู้ดูแล : Thaychasain.CH</h4>
                                                        <h4>วันที่สร้าง : 30/04/2017</h4>
                                                        <h4>วันหมดเขต : 30/06/2017</h4>
                                                ...
                                                <!-- Info box -->
                                                    <div class="box box-solid box-info">
                                                        <div class="box-header">
                                                            <h3 class="box-title">โปรโมชั่น : 003</h3>
                                                            <div class="box-tools pull-right">
                                                                <button class="btn btn-info btn-sm" data-widget="collapse"><i class="fa fa-minus"></i></button>
                                                                <button class="btn btn-info btn-sm" ><i class="fa fa-cog"></i></button>
                                                            </div>
                                                        ...
                                                        <div class="box-body">
                                                        <img class="img-responsive" src="image/pro1/3.jpg" alt="Chania">
                                                        <h4>โปรโมชั่น : 001</h4>
                                                        <h4>ผู้ดูแล : Thaychasain.CH</h4>
                                                        <h4>วันที่สร้าง : 30/04/2017</h4>
                                                        <h4>วันหมดเขต : 30/06/2017</h4>
