...
<!--[if gt IE 8]><!--> <html class="no-js" lang=""> <!--<![endif]-->
    ...
    <body data-spy="scroll" data-target="#main-navbar">
                ...
                <div class="container">
                    ...
                    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                        <ul class="nav navbar-nav navbar-right">
                            ...
                            <li class="active"><a href="#slide3">Packages</a></li>
                            <li class="active"><a href="#slide4">Partner</a></li>
                            <li class="active"><a href="admin/index.php">Free Account</a></li>
                        </ul>
                    </div>
                </div>
            </nav>
        ...
        <section id="slide3" class="sections lightbg">
            <div class="container">
                ...
                <table class="table table-bordered">
                    ...
                    <tr>
                        <th></th>
                        <th width="150">Demp</th>
                        <th width="150">Standard</th>
                        <th width="150">Premium</th>
                        <th width="150">Business Class</th>
                        
                    </tr>
                    </thead>
                    <tbody>
                    <tr>
                        <td>จัดการโปรโมชั่น</td>
                    ...
                    <tr>
                        <td>สรุปสถิติการเข้าถึงโปรโมชั่น</td>
                        <td></td>
                        <td></td>
                        <td align="center"> <span class="glyphicon glyphicon-ok"> </span>  </td>
                        <td align="center"> <span class="glyphicon glyphicon-ok"> </span>  </td>
                    ...
                    <tr>
                        <td>สร้างเงื่อนพิเศษให้กับโปรโมชั่น</td>
                        <td></td>
                        <td></td>
                        <td align="center"> <span class="glyphicon glyphicon-ok"> </span>  </td>
                        <td align="center"> <span class="glyphicon glyphicon-ok"> </span>  </td>
                    ...
                    <tr>
                        <td>วิเคราะห์และสรุปข้อมูลทางธุรกิจ</td>
                        <td></td>
                        <td></td>
                        <td></td>
                        <td align="center"> <span class="glyphicon glyphicon-ok"> </span>  </td>
                    ...
                    <tr>
                        <td>โปรโมทร้านค้าในห้างสรรพสินค้า</td>
                        <td></td>
                        <td></td>
                        <td></td>
                        <td align="center"> <span class="glyphicon glyphicon-ok"> </span>  </td>
        ...
        <section id="slide4" class="sections">
